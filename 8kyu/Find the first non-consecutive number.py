...
# all elements will be numbers. The numbers will also all be unique and in ascending order. The
...
# (This is an empty array and one with a single number and is not
