...
digits as the number itself. For example, 25 is an
automorphic number because its square (625) ends with 25.
...
def automorphic(n: int) -> str:
    res = n**2
    return "Automorphic" if str(res)[-len(str(n)):] == str(n) else "Not!!"
